ALTER TABLE Workspaces ADD COLUMN DocumentIdFormatPreset TEXT NOT NULL DEFAULT 'legacy-numeric'
  CHECK (DocumentIdFormatPreset IN (
    'legacy-numeric',
    'type-year-sequence',
...
ALTER TABLE Workspaces ADD COLUMN DocumentIdFormatTemplate TEXT NOT NULL DEFAULT '<docTypePrefix><year><sequence:5>';
